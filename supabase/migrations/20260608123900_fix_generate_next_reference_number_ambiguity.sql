-- Migration: Fix ambiguous column reference in generate_next_reference_number
-- Date: 2026-06-08
-- Issue: Column reference "numbering_rule_id" is ambiguous
-- Solution: Use explicit table alias in WHERE clause
...
begin
  ...
  -- FIX: Added table alias to resolve ambiguity
...
comment on function public.generate_next_reference_number is 'Generate and consume next reference number. Concurrency-safe. Example: EMP-0001, EMP-0002. Fixed ambiguous column reference issue.';
