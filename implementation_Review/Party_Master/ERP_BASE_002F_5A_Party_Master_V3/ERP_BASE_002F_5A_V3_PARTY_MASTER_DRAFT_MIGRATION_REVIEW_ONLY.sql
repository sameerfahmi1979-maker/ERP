...
CREATE TABLE IF NOT EXISTS party_finance_profiles (
  ...
  payment_hold_by           BIGINT REFERENCES user_profiles(id) ON DELETE SET NULL,
...
CREATE INDEX IF NOT EXISTS idx_party_finance_payment_hold ON party_finance_profiles (payment_hold);
...
INSERT INTO permissions (permission_code, permission_name, description, module_code, is_active)
VALUES
  ('master_data.parties.view',               'View Parties',                   'View party records',                       'MASTER_DATA', true),
  ('master_data.parties.create',             'Create Parties',                 'Create new party records',                 'MASTER_DATA', true),
  ('master_data.parties.edit',               'Edit Parties',                   'Edit existing party records',              'MASTER_DATA', true),
  ('master_data.parties.delete',             'Delete Parties',                 'Delete party records',                     'MASTER_DATA', true),
  ('master_data.parties.deactivate',         'Deactivate Parties',             'Deactivate/reactivate parties',            'MASTER_DATA', true),
  ('master_data.parties.export',             'Export Parties',                 'Export party data to CSV/Excel',           'MASTER_DATA', true),
  ('master_data.parties.manage_types',       'Manage Party Types',             'Create/edit party type master records',    'MASTER_DATA', true),
  ('master_data.parties.manage_services',    'Manage Party Services',          'Manage service category assignments',      'MASTER_DATA', true),
  ('master_data.parties.manage_relationships','Manage Relationships',          'Create/edit party relationships',          'MASTER_DATA', true),
  ('master_data.parties.manage_licenses',    'Manage Licenses',                'Create/edit party licenses',               'MASTER_DATA', true),
  ('master_data.parties.manage_tax',         'Manage Tax Registrations',       'Create/edit tax registrations',            'MASTER_DATA', true),
  ('master_data.parties.manage_contacts',    'Manage Contacts',                'Create/edit party contacts',               'MASTER_DATA', true),
  ('master_data.parties.manage_addresses',   'Manage Addresses',               'Create/edit party addresses',              'MASTER_DATA', true),
  ('master_data.parties.manage_bank_details','Manage Bank Details',            'Create/edit/view party bank details',      'MASTER_DATA', true),
  ('master_data.parties.view_bank_details',  'View Bank Details',              'View bank details (read-only)',            'MASTER_DATA', true),
  ('master_data.parties.verify_bank_details','Verify Bank Details',            'Verify/approve bank details',              'MASTER_DATA', true),
  ('master_data.parties.manage_documents',   'Manage Documents',               'Upload/edit party documents',              'MASTER_DATA', true),
  ('master_data.parties.manage_compliance',  'Manage Compliance',              'Edit compliance profile and holds',        'MASTER_DATA', true),
  ('master_data.parties.approve',            'Approve Parties',                'Approve party vendor/customer status',     'MASTER_DATA', true),
  ('master_data.parties.blacklist',          'Blacklist Parties',              'Set blacklist status',                     'MASTER_DATA', true),
  ('master_data.parties.override_duplicate', 'Override Duplicate Warning',     'Override duplicate detection block',       'MASTER_DATA', true),
  ('master_data.parties.lock',               'Lock Party Record',              'Lock/unlock party for editing',            'MASTER_DATA', true),
  ('master_data.parties.view_audit',         'View Party Audit Log',           'View audit trail for parties',             'MASTER_DATA', true),
  ('master_data.parties.print',              'Print Party Record',             'Print party details',                      'MASTER_DATA', true)
