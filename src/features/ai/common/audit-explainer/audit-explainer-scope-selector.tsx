...
import type { AuditExplainerScope } from "@/lib/ai/common/audit-explainer/types";
import { cn } from "@/lib/utils";

const SCOPES: { value: AuditExplainerScope; label: string }[] = [
...
interface Props {
  ...
  onChange: (scope: AuditExplainerScope) => void;
  disabled?: boolean;
}

export function AuditExplainerScopeSelector({ scope, onChange, disabled }: Props) {
  return (
