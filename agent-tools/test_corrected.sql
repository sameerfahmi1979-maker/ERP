...
('PARTY_STATUS_TYPES', 'INACTIVE', 'Inactive', 'غير نشط', 'Inactive party', 'gray', true, false, false, 20),
('PARTY_STATUS_TYPES', 'BLACKLISTED', 'Blacklisted', 'القائمة السوداء', 'Blacklisted party', 'red', true, false, false, 30),
('PARTY_STATUS_TYPES', 'ON_HOLD', 'On Hold', 'معلق', 'Party on hold', 'yellow', true, false, false, 40),
('PARTY_STATUS_TYPES', 'UNDER_REVIEW', 'Under Review', 'قيد المراجعة', 'Party under review', 'orange', true, false, false, 50)
...
('CUSTOMER_TYPES', 'GOVERNMENT_CUSTOMER', 'Government Customer', 'عميل حكومي', 'Government customer (e.g., municipalities, government entities)', 'purple', true, false, false, 20),
('CUSTOMER_TYPES', 'SEMI_GOVERNMENT_CUSTOMER', 'Semi-Government Customer', 'عميل شبه حكومي', 'Semi-government customer (e.g., Dubai Holding entities)', 'purple', true, false, false, 30),
('CUSTOMER_TYPES', 'UTILITY_COMPANY', 'Utility Company', 'شركة المرافق', 'Utility company (e.g., TAQA, EWEC, DEWA)', 'orange', true, false, false, 40),
('CUSTOMER_TYPES', 'WATER_POWER_PLANT', 'Water & Power Plant', 'محطة المياه والطاقة', 'Water desalination plant or power generation facility', 'cyan', true, false, false, 50),
('CUSTOMER_TYPES', 'INDUSTRIAL_CUSTOMER', 'Industrial Customer', 'عميل صناعي', 'Industrial customer (e.g., manufacturing facilities, factories)', 'brown', true, false, false, 60),
('CUSTOMER_TYPES', 'COMMERCIAL_CUSTOMER', 'Commercial Customer', 'عميل تجاري', 'Commercial customer (e.g., retail, hospitality, commercial real estate)', 'pink', true, false, false, 70),
...
('CUSTOMER_SEGMENTS', 'ENTERPRISE', 'Enterprise', 'مؤسسة كبيرة', 'Enterprise customer', 'purple', false, false, false, 10),
('CUSTOMER_SEGMENTS', 'SME', 'SME', 'شركة صغيرة ومتوسطة', 'Small and medium enterprise', 'blue', false, false, false, 20),
('CUSTOMER_SEGMENTS', 'GOVERNMENT', 'Government', 'حكومي', 'Government sector', 'purple', false, false, false, 30),
('CUSTOMER_SEGMENTS', 'INDUSTRIAL', 'Industrial', 'صناعي', 'Industrial sector', 'brown', false, false, false, 40),
('CUSTOMER_SEGMENTS', 'COMMERCIAL', 'Commercial', 'تجاري', 'Commercial sector', 'pink', false, false, false, 50),
('CUSTOMER_SEGMENTS', 'CONSTRUCTION', 'Construction', 'إنشاءات', 'Construction sector', 'orange', false, false, false, 60),
('CUSTOMER_SEGMENTS', 'LOGISTICS', 'Logistics', 'لوجستيات', 'Logistics sector', 'cyan', false, false, false, 70),
('CUSTOMER_SEGMENTS', 'RETAIL', 'Retail', 'تجزئة', 'Retail sector', 'green', false, false, false, 80),
('CUSTOMER_SEGMENTS', 'HOSPITALITY', 'Hospitality', 'ضيافة', 'Hospitality sector', 'yellow', false, false, false, 90),
('CUSTOMER_SEGMENTS', 'OTHER', 'Other', 'أخرى', 'Other segment', 'gray', false, false, false, 100)
...
('VENDOR_TYPES', 'TRANSPORTER', 'Transporter', 'ناقل', 'Transport service vendor (general transport services)', 'cyan', true, false, false, 50),
('VENDOR_TYPES', 'TRANSPORT_SERVICE_PROVIDER', 'Transport Service Provider', 'مزود خدمة النقل', 'Specialized transport service provider', 'cyan', true, false, false, 60),
('VENDOR_TYPES', 'LOGISTICS_SERVICE_PROVIDER', 'Logistics Service Provider', 'مزود خدمة لوجستية', '3PL logistics service provider', 'cyan', true, false, false, 70),
('VENDOR_TYPES', 'PRIVATE_WASTE_DISPOSAL_FACILITY', 'Private Waste Disposal Facility', 'مرفق التخلص من النفايات الخاصة', 'Private waste treatment/disposal company', 'green', true, false, false, 80),
('VENDOR_TYPES', 'WASTE_DISPOSAL_SERVICE_PROVIDER', 'Waste Disposal Service Provider', 'مزود خدمة التخلص من النفايات', 'Waste management service vendor', 'green', true, false, false, 90),
...
('VENDOR_CATEGORIES', 'PREFERRED', 'Preferred Vendor', 'مورد مفضل', 'Preferred vendor', 'green', false, false, false, 10),
('VENDOR_CATEGORIES', 'APPROVED', 'Approved Vendor', 'مورد معتمد', 'Approved vendor', 'blue', false, false, false, 20),
('VENDOR_CATEGORIES', 'TRIAL', 'Trial Vendor', 'مورد تجريبي', 'Trial vendor', 'yellow', false, false, false, 30),
('VENDOR_CATEGORIES', 'LOCAL', 'Local Vendor', 'مورد محلي', 'Local UAE vendor', 'cyan', false, false, false, 40),
('VENDOR_CATEGORIES', 'INTERNATIONAL', 'International Vendor', 'مورد دولي', 'International vendor', 'purple', false, false, false, 50),
('VENDOR_CATEGORIES', 'STRATEGIC', 'Strategic Vendor', 'مورد استراتيجي', 'Strategic vendor', 'gold', false, false, false, 60),
('VENDOR_CATEGORIES', 'ONE_TIME', 'One-Time Vendor', 'مورد لمرة واحدة', 'One-time vendor', 'gray', false, false, false, 70),
('VENDOR_CATEGORIES', 'BLOCKED', 'Blocked Vendor', 'مورد محظور', 'Blocked vendor', 'red', false, false, false, 80)
...
('SUPPLIER_CATEGORIES', 'RAW_MATERIALS', 'Raw Materials', 'المواد الخام', 'Raw materials supplier', 'green', false, false, false, 10),
('SUPPLIER_CATEGORIES', 'SPARE_PARTS', 'Spare Parts', 'قطع الغيار', 'Spare parts supplier', 'orange', false, false, false, 20),
('SUPPLIER_CATEGORIES', 'CONSUMABLES', 'Consumables', 'المواد الاستهلاكية', 'Consumables supplier', 'blue', false, false, false, 30),
('SUPPLIER_CATEGORIES', 'MACHINERY', 'Machinery', 'الآلات', 'Machinery supplier', 'purple', false, false, false, 40),
('SUPPLIER_CATEGORIES', 'CHEMICALS', 'Chemicals', 'المواد الكيميائية', 'Chemicals supplier', 'yellow', false, false, false, 50),
('SUPPLIER_CATEGORIES', 'PACKAGING', 'Packaging', 'التغليف', 'Packaging supplier', 'pink', false, false, false, 60)
...
('SUBCONTRACTOR_TYPES', 'CIVIL_SUBCONTRACTOR', 'Civil Subcontractor', 'مقاول مدني من الباطن', 'Civil subcontractor', 'blue', true, false, true, 10),
('SUBCONTRACTOR_TYPES', 'MANPOWER_SUBCONTRACTOR', 'Manpower Subcontractor', 'مقاول عمالة من الباطن', 'Manpower subcontractor', 'green', true, false, false, 20),
('SUBCONTRACTOR_TYPES', 'TRANSPORTER', 'Transporter', 'ناقل', 'Transporter subcontractor (project execution)', 'orange', true, false, false, 30),
('SUBCONTRACTOR_TYPES', 'TRANSPORT_SUBCONTRACTOR', 'Transport Subcontractor', 'مقاول نقل من الباطن', 'Transport subcontractor (subcontracted for project execution)', 'orange', true, false, false, 40),
('SUBCONTRACTOR_TYPES', 'DEMOLITION_SUBCONTRACTOR', 'Demolition Subcontractor', 'مقاول هدم من الباطن', 'Demolition subcontractor', 'red', true, false, false, 50),
('SUBCONTRACTOR_TYPES', 'EQUIPMENT_SUBCONTRACTOR', 'Equipment Subcontractor', 'مقاول معدات من الباطن', 'Equipment subcontractor', 'purple', true, false, false, 60),
('SUBCONTRACTOR_TYPES', 'SPECIALIZED_SUBCONTRACTOR', 'Specialized Subcontractor', 'مقاول متخصص من الباطن', 'Specialized subcontractor (painting, electrical, HVAC, etc.)', 'cyan', true, false, false, 70),
('SUBCONTRACTOR_TYPES', 'PARTNER_SUBCONTRACTOR', 'Partner Subcontractor', 'مقاول شريك من الباطن', 'Partner subcontractor', 'gold', true, false, false, 80)
...
('SUBCONTRACTOR_CATEGORIES', 'PREFERRED', 'Preferred Subcontractor', 'مقاول من الباطن مفضل', 'Preferred subcontractor', 'green', false, false, false, 10),
('SUBCONTRACTOR_CATEGORIES', 'APPROVED', 'Approved Subcontractor', 'مقاول من الباطن معتمد', 'Approved subcontractor', 'blue', false, false, false, 20),
('SUBCONTRACTOR_CATEGORIES', 'TRIAL', 'Trial Subcontractor', 'مقاول من الباطن تجريبي', 'Trial subcontractor', 'yellow', false, false, false, 30),
('SUBCONTRACTOR_CATEGORIES', 'LOCAL', 'Local Subcontractor', 'مقاول من الباطن محلي', 'Local UAE subcontractor', 'cyan', false, false, false, 40),
('SUBCONTRACTOR_CATEGORIES', 'INTERNATIONAL', 'International Subcontractor', 'مقاول من الباطن دولي', 'International subcontractor', 'purple', false, false, false, 50),
('SUBCONTRACTOR_CATEGORIES', 'BLOCKED', 'Blocked Subcontractor', 'مقاول من الباطن محظور', 'Blocked subcontractor', 'red', false, false, false, 60)
...
('CONSULTANT_TYPES', 'ENGINEERING_CONSULTANT', 'Engineering Consultant', 'استشاري هندسي', 'Engineering consultant', 'blue', true, false, true, 10),
('CONSULTANT_TYPES', 'HSE_CONSULTANT', 'HSE Consultant', 'استشاري الصحة والسلامة والبيئة', 'HSE consultant', 'red', true, false, false, 20),
('CONSULTANT_TYPES', 'LEGAL_CONSULTANT', 'Legal Consultant', 'استشاري قانوني', 'Legal consultant', 'purple', true, false, false, 30),
('CONSULTANT_TYPES', 'TECHNICAL_CONSULTANT', 'Technical Consultant', 'استشاري فني', 'Technical consultant', 'green', true, false, false, 40),
('CONSULTANT_TYPES', 'ENVIRONMENTAL_CONSULTANT', 'Environmental Consultant', 'استشاري بيئي', 'Environmental consultant', 'green', true, false, false, 50),
('CONSULTANT_TYPES', 'AUDIT_CONSULTANT', 'Audit Consultant', 'استشاري تدقيق', 'Audit consultant (financial, operational, compliance)', 'orange', true, false, false, 60)
...
('CONSULTANT_CATEGORIES', 'RETAINER', 'Retainer Consultant', 'استشاري محتفظ به', 'Retainer consultant', 'green', false, false, false, 10),
('CONSULTANT_CATEGORIES', 'PROJECT_BASED', 'Project-Based Consultant', 'استشاري على أساس المشروع', 'Project-based consultant', 'blue', false, false, false, 20),
('CONSULTANT_CATEGORIES', 'ADHOC', 'Ad-Hoc Consultant', 'استشاري مخصص', 'Ad-hoc consultant', 'yellow', false, false, false, 30),
('CONSULTANT_CATEGORIES', 'STRATEGIC', 'Strategic Consultant', 'استشاري استراتيجي', 'Strategic consultant', 'purple', false, false, false, 40)
...
('GOVERNMENT_AUTHORITY_TYPES', 'LICENSE_ISSUER', 'License Issuer', 'مصدر الرخصة', 'License issuer (e.g., Dubai Economic Department)', 'blue', true, false, false, 10),
('GOVERNMENT_AUTHORITY_TYPES', 'PERMIT_ISSUER', 'Permit Issuer', 'مصدر التصريح', 'Permit issuer (e.g., CICPA, environmental permits)', 'blue', true, false, false, 20),
('GOVERNMENT_AUTHORITY_TYPES', 'REGULATOR', 'Regulator', 'المنظم', 'Regulator', 'gray', true, false, true, 30),
('GOVERNMENT_AUTHORITY_TYPES', 'MUNICIPALITY', 'Municipality', 'البلدية', 'Municipality', 'blue', true, false, false, 40),
('GOVERNMENT_AUTHORITY_TYPES', 'POLICE', 'Police', 'الشرطة', 'Police', 'red', true, false, false, 50),
('GOVERNMENT_AUTHORITY_TYPES', 'CIVIL_DEFENSE', 'Civil Defense', 'الدفاع المدني', 'Civil defense', 'red', true, false, false, 60),
('GOVERNMENT_AUTHORITY_TYPES', 'ENVIRONMENTAL_AUTHORITY', 'Environmental Authority', 'الهيئة البيئية', 'Environmental authority', 'green', true, false, false, 70),
('GOVERNMENT_AUTHORITY_TYPES', 'FREE_ZONE_AUTHORITY', 'Free Zone Authority', 'هيئة المنطقة الحرة', 'Free zone authority', 'purple', true, false, false, 80),
('GOVERNMENT_AUTHORITY_TYPES', 'PORT_AUTHORITY', 'Port Authority', 'سلطة الميناء', 'Port authority', 'cyan', true, false, false, 90),
('GOVERNMENT_AUTHORITY_TYPES', 'CUSTOMS_AUTHORITY', 'Customs Authority', 'سلطة الجمارك', 'Customs authority', 'cyan', true, false, false, 100),
('GOVERNMENT_AUTHORITY_TYPES', 'PORT_CUSTOMS_AUTHORITY', 'Port & Customs Authority', 'سلطة الميناء والجمارك', 'Combined port and customs authority', 'cyan', true, false, false, 110),
('GOVERNMENT_AUTHORITY_TYPES', 'UTILITY_AUTHORITY', 'Utility Authority', 'سلطة المرافق', 'Utility authority', 'orange', true, false, false, 120),
('GOVERNMENT_AUTHORITY_TYPES', 'TRANSPORT_AUTHORITY', 'Transport Authority', 'سلطة النقل', 'Transport authority (e.g., Dubai RTA, Abu Dhabi DOT)', 'orange', true, false, false, 130),
('GOVERNMENT_AUTHORITY_TYPES', 'WASTE_DISPOSAL_FACILITY', 'Waste Disposal Facility', 'مرفق التخلص من النفايات', 'Government waste disposal facility', 'green', true, false, false, 140),
('GOVERNMENT_AUTHORITY_TYPES', 'GOVERNMENT_WASTE_DISPOSAL_AUTHORITY', 'Govt Waste Disposal Authority', 'سلطة التخلص من النفايات الحكومية', 'Government waste disposal authority', 'green', true, false, false, 150),
('GOVERNMENT_AUTHORITY_TYPES', 'MINISTRY', 'Ministry', 'الوزارة', 'Ministry', 'purple', true, false, false, 160)
...
('GOVERNMENT_AUTHORITY_CATEGORIES', 'FEDERAL', 'Federal Authority', 'جهة اتحادية', 'Federal authority', 'purple', false, false, false, 10),
('GOVERNMENT_AUTHORITY_CATEGORIES', 'EMIRATE', 'Emirate Authority', 'جهة إمارة', 'Emirate authority', 'blue', false, false, false, 20),
('GOVERNMENT_AUTHORITY_CATEGORIES', 'LOCAL', 'Local Authority', 'جهة محلية', 'Local authority', 'cyan', false, false, false, 30),
('GOVERNMENT_AUTHORITY_CATEGORIES', 'FREE_ZONE', 'Free Zone Authority', 'جهة منطقة حرة', 'Free zone authority', 'purple', false, false, false, 40)
...
('JURISDICTION_LEVEL_TYPES', 'FEDERAL', 'Federal', 'اتحادي', 'Federal jurisdiction', 'purple', true, false, false, 10),
('JURISDICTION_LEVEL_TYPES', 'EMIRATE', 'Emirate', 'إمارة', 'Emirate jurisdiction', 'blue', true, false, false, 20),
('JURISDICTION_LEVEL_TYPES', 'MUNICIPALITY', 'Municipality', 'بلدية', 'Municipality jurisdiction', 'cyan', true, false, false, 30),
('JURISDICTION_LEVEL_TYPES', 'FREE_ZONE', 'Free Zone', 'منطقة حرة', 'Free zone jurisdiction', 'purple', true, false, false, 40)
...
('RECRUITMENT_AGENCY_TYPES', 'LOCAL_RECRUITMENT_AGENCY', 'Local Recruitment Agency', 'وكالة توظيف محلية', 'Local UAE recruitment agency', 'blue', true, false, false, 10),
('RECRUITMENT_AGENCY_TYPES', 'OVERSEAS_RECRUITMENT_AGENCY', 'Overseas Recruitment Agency', 'وكالة توظيف خارجية', 'Overseas recruitment agency', 'purple', true, false, false, 20),
('RECRUITMENT_AGENCY_TYPES', 'MANPOWER_SUPPLY_AGENCY', 'Manpower Supply Agency', 'وكالة توريد القوى العاملة', 'Manpower supply agency', 'green', true, false, false, 30),
('RECRUITMENT_AGENCY_TYPES', 'EXECUTIVE_SEARCH_AGENCY', 'Executive Search Agency', 'وكالة البحث التنفيذي', 'Executive search agency', 'gold', true, false, false, 40)
...
('RECRUITMENT_AGENCY_CATEGORIES', 'PREFERRED', 'Preferred Agency', 'وكالة مفضلة', 'Preferred recruitment agency', 'green', false, false, false, 10),
('RECRUITMENT_AGENCY_CATEGORIES', 'APPROVED', 'Approved Agency', 'وكالة معتمدة', 'Approved recruitment agency', 'blue', false, false, false, 20),
('RECRUITMENT_AGENCY_CATEGORIES', 'TRIAL', 'Trial Agency', 'وكالة تجريبية', 'Trial recruitment agency', 'yellow', false, false, false, 30),
('RECRUITMENT_AGENCY_CATEGORIES', 'BLOCKED', 'Blocked Agency', 'وكالة محظورة', 'Blocked recruitment agency', 'red', false, false, false, 40)
...
('INDUSTRY_TYPES', 'CONSTRUCTION', 'Construction', 'إنشاءات', 'Construction industry', 'orange', false, false, false, 10),
('INDUSTRY_TYPES', 'MANUFACTURING', 'Manufacturing', 'تصنيع', 'Manufacturing industry', 'brown', false, false, false, 20),
('INDUSTRY_TYPES', 'LOGISTICS', 'Logistics', 'لوجستيات', 'Logistics industry', 'cyan', false, false, false, 30),
('INDUSTRY_TYPES', 'RETAIL', 'Retail', 'تجزئة', 'Retail industry', 'green', false, false, false, 40),
('INDUSTRY_TYPES', 'HOSPITALITY', 'Hospitality', 'ضيافة', 'Hospitality industry', 'yellow', false, false, false, 50),
('INDUSTRY_TYPES', 'GOVERNMENT', 'Government', 'حكومي', 'Government sector', 'purple', false, false, false, 60),
('INDUSTRY_TYPES', 'UTILITIES', 'Utilities', 'المرافق', 'Utilities industry', 'orange', false, false, false, 70),
('INDUSTRY_TYPES', 'ENERGY', 'Energy', 'طاقة', 'Energy industry', 'red', false, false, false, 80),
('INDUSTRY_TYPES', 'HEALTHCARE', 'Healthcare', 'رعاية صحية', 'Healthcare industry', 'pink', false, false, false, 90),
('INDUSTRY_TYPES', 'REAL_ESTATE', 'Real Estate', 'عقارات', 'Real estate industry', 'brown', false, false, false, 100),
('INDUSTRY_TYPES', 'TECHNOLOGY', 'Technology', 'تقنية', 'Technology industry', 'blue', false, false, false, 110),
('INDUSTRY_TYPES', 'OTHER', 'Other', 'أخرى', 'Other industry', 'gray', false, false, false, 120)
...
('CRM_LEAD_SOURCES', 'WEBSITE', 'Website', 'موقع إلكتروني', 'Website inquiry', 'blue', false, false, false, 10),
('CRM_LEAD_SOURCES', 'REFERRAL', 'Referral', 'إحالة', 'Customer referral', 'green', false, false, false, 20),
('CRM_LEAD_SOURCES', 'DIRECT_SALES', 'Direct Sales', 'مبيعات مباشرة', 'Direct sales team', 'purple', false, false, false, 30),
('CRM_LEAD_SOURCES', 'SOCIAL_MEDIA', 'Social Media', 'وسائل التواصل الاجتماعي', 'Social media', 'cyan', false, false, false, 40),
('CRM_LEAD_SOURCES', 'EMAIL_CAMPAIGN', 'Email Campaign', 'حملة البريد الإلكتروني', 'Email marketing campaign', 'orange', false, false, false, 50),
('CRM_LEAD_SOURCES', 'TRADE_SHOW', 'Trade Show', 'معرض تجاري', 'Trade show/exhibition', 'yellow', false, false, false, 60),
('CRM_LEAD_SOURCES', 'COLD_CALL', 'Cold Call', 'مكالمة باردة', 'Cold call', 'gray', false, false, false, 70),
('CRM_LEAD_SOURCES', 'EXISTING_CUSTOMER', 'Existing Customer', 'عميل حالي', 'Existing customer', 'green', false, false, false, 80),
('CRM_LEAD_SOURCES', 'PARTNER', 'Partner', 'شريك', 'Partner referral', 'gold', false, false, false, 90),
('CRM_LEAD_SOURCES', 'OTHER', 'Other', 'أخرى', 'Other source', 'gray', false, false, false, 100)
...
('CONTACT_TYPES', 'PRIMARY', 'Primary Contact', 'جهة اتصال رئيسية', 'Primary contact', 'blue', false, false, false, 10),
('CONTACT_TYPES', 'FINANCE', 'Finance Contact', 'جهة اتصال مالية', 'Finance contact', 'green', false, false, false, 20),
('CONTACT_TYPES', 'OPERATIONS', 'Operations Contact', 'جهة اتصال تشغيلية', 'Operations contact', 'orange', false, false, false, 30),
('CONTACT_TYPES', 'TECHNICAL', 'Technical Contact', 'جهة اتصال فنية', 'Technical contact', 'purple', false, false, false, 40),
('CONTACT_TYPES', 'SALES', 'Sales Contact', 'جهة اتصال مبيعات', 'Sales contact', 'cyan', false, false, false, 50),
('CONTACT_TYPES', 'LEGAL', 'Legal Contact', 'جهة اتصال قانونية', 'Legal contact', 'red', false, false, false, 60),
('CONTACT_TYPES', 'AUTHORIZED_SIGNATORY', 'Authorized Signatory', 'مفوض بالتوقيع', 'Authorized signatory', 'gold', false, false, false, 70),
('CONTACT_TYPES', 'OTHER', 'Other Contact', 'جهة اتصال أخرى', 'Other contact', 'gray', false, false, false, 80)
...
('COMMUNICATION_PREFERENCE_TYPES', 'EMAIL', 'Email', 'البريد الإلكتروني', 'Email communication', 'blue', false, false, false, 10),
('COMMUNICATION_PREFERENCE_TYPES', 'PHONE', 'Phone', 'هاتف', 'Phone communication', 'green', false, false, false, 20),
('COMMUNICATION_PREFERENCE_TYPES', 'WHATSAPP', 'WhatsApp', 'واتساب', 'WhatsApp communication', 'green', false, false, false, 30),
('COMMUNICATION_PREFERENCE_TYPES', 'SMS', 'SMS', 'رسالة نصية', 'SMS communication', 'orange', false, false, false, 40),
('COMMUNICATION_PREFERENCE_TYPES', 'IN_PERSON', 'In Person', 'شخصياً', 'In-person communication', 'purple', false, false, false, 50),
('COMMUNICATION_PREFERENCE_TYPES', 'NO_CONTACT', 'No Contact', 'لا تواصل', 'Do not contact', 'red', false, false, false, 60)
...
('ADDRESS_TYPES', 'BILLING', 'Billing Address', 'عنوان الفواتير', 'Billing address', 'blue', false, false, false, 10),
('ADDRESS_TYPES', 'SHIPPING', 'Shipping Address', 'عنوان الشحن', 'Shipping address', 'green', false, false, false, 20),
('ADDRESS_TYPES', 'SITE', 'Site Address', 'عنوان الموقع', 'Site address', 'orange', false, false, false, 30),
('ADDRESS_TYPES', 'OFFICE', 'Office Address', 'عنوان المكتب', 'Office address', 'purple', false, false, false, 40),
('ADDRESS_TYPES', 'OTHER', 'Other Address', 'عنوان آخر', 'Other address', 'gray', false, false, false, 50)
...
('PARTY_DOCUMENT_TYPES', 'TRN_CERTIFICATE', 'TRN Certificate', 'شهادة التسجيل الضريبي', 'Tax Registration Number certificate', 'blue', false, false, false, 10),
('PARTY_DOCUMENT_TYPES', 'TRADE_LICENSE', 'Trade License', 'الرخصة التجارية', 'Trade license', 'blue', false, false, false, 20),
('PARTY_DOCUMENT_TYPES', 'INSURANCE_POLICY', 'Insurance Policy', 'وثيقة التأمين', 'Insurance policy', 'green', false, false, false, 30),
('PARTY_DOCUMENT_TYPES', 'REGISTRATION_CERTIFICATE', 'Registration Certificate', 'شهادة التسجيل', 'Registration certificate', 'purple', false, false, false, 40),
('PARTY_DOCUMENT_TYPES', 'HSE_CERTIFICATE', 'HSE Certificate', 'شهادة الصحة والسلامة والبيئة', 'HSE certificate', 'red', false, false, false, 50),
('PARTY_DOCUMENT_TYPES', 'QUALITY_CERTIFICATE', 'Quality Certificate', 'شهادة الجودة', 'Quality certificate', 'orange', false, false, false, 60),
('PARTY_DOCUMENT_TYPES', 'AUTHORIZATION_LETTER', 'Authorization Letter', 'خطاب التفويض', 'Authorization letter', 'yellow', false, false, false, 70),
('PARTY_DOCUMENT_TYPES', 'BANK_LETTER', 'Bank Letter', 'خطاب البنك', 'Bank letter', 'cyan', false, false, false, 80),
('PARTY_DOCUMENT_TYPES', 'CONTRACT', 'Contract', 'عقد', 'Contract', 'purple', false, false, false, 90),
('PARTY_DOCUMENT_TYPES', 'MOU', 'MOU', 'مذكرة تفاهم', 'Memorandum of Understanding', 'blue', false, false, false, 100),
('PARTY_DOCUMENT_TYPES', 'ID_DOCUMENT', 'ID Document', 'وثيقة الهوية', 'ID document', 'gray', false, false, false, 110),
('PARTY_DOCUMENT_TYPES', 'OTHER', 'Other Document', 'مستند آخر', 'Other document', 'gray', false, false, false, 120)
...
('BANK_ACCOUNT_TYPES', 'CURRENT', 'Current Account', 'حساب جاري', 'Current account', 'blue', false, false, false, 10),
('BANK_ACCOUNT_TYPES', 'SAVINGS', 'Savings Account', 'حساب توفير', 'Savings account', 'green', false, false, false, 20),
('BANK_ACCOUNT_TYPES', 'BUSINESS', 'Business Account', 'حساب تجاري', 'Business account', 'purple', false, false, false, 30),
('BANK_ACCOUNT_TYPES', 'ESCROW', 'Escrow Account', 'حساب ضمان', 'Escrow account', 'orange', false, false, false, 40)
