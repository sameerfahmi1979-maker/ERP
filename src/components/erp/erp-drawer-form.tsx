...
export function ERPDrawerForm({
  ...
  // Sync this drawer's dirty state to the active workspace tab (ERP GLOBAL UI.4B).
  // No-op when outside WorkspaceProvider or in view mode.
...
export function ERPDrawerBody({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <ScrollArea className={cn("flex-1 p-6 min-h-0", className)}>
