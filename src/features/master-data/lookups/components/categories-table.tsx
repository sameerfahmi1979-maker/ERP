...
export function CategoriesTable({ categories, onRefresh }: CategoriesTableProps) {
  ...
  const [selectedCategory, setSelectedCategory] = useState<LookupCategoryWithStats | null>(null);
  ...
  const handleView = (category: LookupCategoryWithStats) => {
    setSelectedCategory(category);
    setFormMode("view");
    setIsFormOpen(true);
  };

  const handleEdit = (category: LookupCategoryWithStats) => {
    setSelectedCategory(category);
    setFormMode("edit");
    setIsFormOpen(true);
  };
