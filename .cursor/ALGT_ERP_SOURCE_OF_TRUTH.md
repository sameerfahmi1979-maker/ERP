...
| Common MD Hub | `/admin/common-master-data` | LIVE | ✅ | `src/app/(protected)/admin/common-master-data/page.tsx` | — | LIVE | COMMON MD.1 — landing page with 6 tile navigation |
| Departments | `/admin/common-master-data/departments` | LIVE | ✅ | `src/features/common-master-data/departments/` | `common-master-data/departments.ts` | LIVE | COMMON MD.1. `common_md.departments.*` permissions. |
| Designations | `/admin/common-master-data/designations` | LIVE | ✅ | `src/features/common-master-data/designations/` | `common-master-data/designations.ts` | LIVE | COMMON MD.1. `common_md.designations.*` permissions. |
| Work Sites | `/admin/common-master-data/work-sites` | LIVE | ✅ | `src/features/common-master-data/work-sites/` | `common-master-data/work-sites.ts` | LIVE | COMMON MD.1. DmsEntityDocumentsTab (entityType=site). `common_md.work_sites.*` permissions. |
| Work Calendars | `/admin/common-master-data/work-calendars` | LIVE | ✅ | `src/features/common-master-data/work-calendars/` | `common-master-data/work-calendars.ts` | LIVE | COMMON MD.1. Inline shift CRUD on Shifts tab. `common_md.work_calendars.*` permissions. |
| Approval Roles | `/admin/common-master-data/approval-roles` | LIVE | ✅ | `src/features/common-master-data/approval-roles/` | `common-master-data/approval-roles.ts` | LIVE | COMMON MD.1. `common_md.approval_roles.*` permissions. |
| Required Doc. Rules | `/admin/common-master-data/dms-required-documents` | LIVE | ✅ | `src/features/common-master-data/dms-required-document-rules/` | `common-master-data/dms-required-document-rules.ts` | LIVE | COMMON MD.1. 8 seeded rules (company/site). `common_md.dms_required_documents.*` permissions. |
