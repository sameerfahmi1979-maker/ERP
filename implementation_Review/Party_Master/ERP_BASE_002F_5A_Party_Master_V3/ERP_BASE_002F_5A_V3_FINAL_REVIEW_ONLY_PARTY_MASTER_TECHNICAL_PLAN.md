...
| 2 | `party_finance_profiles` missing `payment_hold_by` and `payment_hold_at` | Added both columns |
...
Override requires `override_duplicate` permission + `logAudit(DUPLICATE_OVERRIDE)`.
