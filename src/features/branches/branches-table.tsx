...
export function BranchesTable({ 
  ...
  const handleView = (branch: BranchWithCompany) => router.push(`${BASE}/record/${branch.id}`);
  const handleEdit = (branch: BranchWithCompany) => router.push(`${BASE}/record/${branch.id}?mode=edit`);
